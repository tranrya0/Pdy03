...
namespace ContosoUniversity.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            // add filtering to serch by last name or first name
            // only leave students in the students list where
            // their first or last name contains the searchString
            // Contains method between .NET framework and Entity Framework provides
            // different results, so calling ToUpper() to make search case insensitive
